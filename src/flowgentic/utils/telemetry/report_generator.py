...
class ReportGenerator:
    ...
    def generate_report(self, all_nodes: List[str], dir_to_write: str):
        ...
        with open(output_path, "w", encoding="utf-8") as f:
            ...
            for node_name in all_nodes:
                ...
                if self._node_was_visited(node_name):
                    ...
                    for record in records:
                        ...
                        node_category_messages += record.new_messages_count
            ...
            for i, record in enumerate(report_data.node_records):
                ...
                f.write(
                    ...
                    f"`{record.total_messages_before}` -> "
                    f"`{record.total_messages_after}` "
                    f"(+ {record.new_messages_count})\n"
                )
        ...
        logger.info("Introspection report saved to '%s'", dir_to_write)
