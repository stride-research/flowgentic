"""Demo-only infrastructure for the Flowgentic synthetic AI-HPC example.

This module isolates synthetic science, timing, failure injection,
console formatting, local backend construction, and artifact generation from
the audience-facing application code in ``application.py``.
"""
...
async def evaluate_candidate(
    ...
    """Run the deterministic synthetic simulation used by the live demo."""
...
def initial_campaign_state(
    ...
    """Create the initial structured state for the agent graph."""
    return {
        "messages": [
            HumanMessage(
                content=(
