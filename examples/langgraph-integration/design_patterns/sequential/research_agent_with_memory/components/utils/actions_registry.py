"""
Centralized registry for memory-aware tools and tasks.

This registry manages all agent tools and deterministic tasks for the
...
class ActionsRegistry(BaseToolRegistry):
	"""Unified interface for all workflow tools and tasks with memory awareness."""
